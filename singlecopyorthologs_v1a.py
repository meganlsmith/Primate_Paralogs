...
Then, the script save trees that contained at least the specified number of species and only
a single sequence per species.
Finally, the user must supply an output file for filtered trees (default ./SCO_trees).
