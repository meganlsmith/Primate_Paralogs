...
The script will find lineage-specific duplicates and two-lineage duplicates. It will
clip until only one copy is left for these duplication events.  Sequences must be named
