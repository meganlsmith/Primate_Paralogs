...
Then, the script will prune lineage-specific duplicates and save trees that contained no duplications
except lineage-specific duplicates with said duplicates removed.
Finally, the user must supply an output file for pruned trees (default ./LineageSpecDuplicates_trees).
...
parser.add_option("-o","--outputtrees", help="Folder in which to store pruned trees.",
                    default="LineageSpecDuplicates_trees",
...
for tree in treestoparse: # for each tree
    ...
    # crate a list to store taxa to drop from tree
    droplist=[]
